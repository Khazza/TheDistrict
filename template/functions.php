    ...
    ?>
        <footer class="footer text-center py-3 mt-2 mb-3">
            <div class="container d-flex align-items-center justify-content-between h-100">
                <div>
                    <a href="../legal-notice.php" class="mr-auto footer-link">Mentions légales</a>
                    <a href="../privacy-policy.php" class="mr-auto footer-link">Politique de confidentialité</a>
                </div>
                <div>
